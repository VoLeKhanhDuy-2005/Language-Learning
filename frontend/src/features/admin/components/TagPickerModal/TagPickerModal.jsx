    ...
    <div className="tag-modal-overlay" onClick={onClose}>
      <div className="tag-modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="tag-modal-body">
          ...
          {!isCreatingNew ? (
            <button
              className="tag-modal-create-btn"
          ...
          {createTagError && (
            <div className="tag-modal-error">{createTagError}</div>
          )}

          {/* Search Bar */}
          <div className="tag-modal-search">
            <svg
              className="tag-modal-search-icon"
              viewBox="0 0 24 24"
              width="16"
              height="16"
              fill="none"
