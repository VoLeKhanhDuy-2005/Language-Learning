...
function AdminDeckEditPage({ onNavigate, deckId }) {
  ...
  useEffect(() => {
    const loadDeckData = async () => {
      try {
        ...
        setSelectedCefr(
          deck.cefrLevelIds
            ? deck.cefrLevelIds.map((c) => (typeof c === "object" ? c._id : c))
            : [],
        );
  ...
  const handleTagsChange = (newTags) => {
    ...
    setSelectedTags((prev) =>
      prev.filter((t) => newTags.find((nt) => nt._id === t._id)),
    );
  };
          ...
          <div className="admin-create-section">
            ...
            <div className="admin-create-section-body">
              ...
              <div className="admin-textarea-group">
                <label htmlFor="deck-desc" className="admin-textarea-label">
                  {t("admin.descLabel").toUpperCase()}
                </label>
                <textarea
                  id="deck-desc"
            ...
            <div className="admin-create-section-body">
              <div className="admin-upload-area">
                {coverImage ? (
                  <img
                    src={coverImage}
                    alt={title || t("admin.sectionImage")}
