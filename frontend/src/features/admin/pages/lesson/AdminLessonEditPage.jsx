...
function AdminLessonEditPage({ lessonId, onNavigate }) {
  ...
  const handleTagsChange = (newTags) => {
    ...
    setSelectedTags((prev) =>
      prev.filter((tag) => newTags.find((item) => item._id === tag._id)),
    );
  };
    ...
    <div className="admin-create-page admin-lesson-form-page">
      <div className="admin-create-page-header">
        ...
        <div className="admin-create-header-actions">
          <button
            ...
            onClick={() =>
              onNavigate && onNavigate(`/admin/lessons/${lessonId}/segments`)
            }
          >
      ...
      <div className="admin-create-body">
        <div className="admin-create-left">
          <div className="admin-create-section">
            <div className="admin-create-section-header">
              ...
              <h2 className="admin-create-section-title">
                {t("admin.lessonSectionContent")}
              </h2>
            </div>
            <div className="admin-create-section-body">
              ...
              <div className="admin-textarea-group">
                <label htmlFor="lesson-desc" className="admin-textarea-label">
                  {t("admin.lessonDescLabel").toUpperCase()}
                </label>
                <textarea
                  id="lesson-desc"
              ...
              <div className="admin-lesson-media-row">
                <div className="admin-upload-area admin-lesson-upload-visual">
                  {thumbnailUrl ? (
                    <img
                      src={thumbnailUrl}
                      alt={title || t("admin.lessonPreviewAlt")}
                    ...
                    <>
                      ...
                      <p className="admin-upload-hint">
                        {t("admin.lessonThumbnailUploadHint")}
                      </p>
                      <p className="admin-upload-desc">
                        {t("admin.imageUploadDesc")}
                      </p>
                    </>
                  )}
                  <label
                    className={`admin-upload-action ${isImageUploading ? "is-uploading" : ""}`}
                    style={{ marginTop: thumbnailUrl ? "8px" : "0" }}
                  >
                    <input
                      type="file"
        ...
        <div className="admin-create-right">
          <div className="admin-create-section">
            <h2 className="admin-create-classify-title">
              {t("admin.sectionClassify")}
            </h2>

            <div className="admin-classify-group">
              <label className="admin-classify-label">
                {t("admin.cefrLabel")}
              </label>
            ...
            <div className="admin-classify-group">
              ...
              <div className="admin-status-options">
                <label
                  className={`admin-status-card ${status === "draft" ? "active" : ""}`}
                >
                  <input
                    type="radio"
                    name="lesson-status"
                  ...
                  <div>
                    <div className="admin-status-name">
                      {t("admin.statusDraft")}
                    </div>
                    <div className="admin-status-desc">
                      {t("admin.statusDraftDesc")}
                    </div>
                  </div>
                </label>

                <label
                  className={`admin-status-card ${status === "published" ? "active" : ""}`}
                >
                  <input
                    type="radio"
                    name="lesson-status"
                  ...
                  <div>
                    ...
                    <div className="admin-status-desc">
                      {t("admin.statusPublishedDesc")}
                    </div>
                  </div>
                </label>

                <label
                  className={`admin-status-card ${status === "archived" ? "active" : ""}`}
                >
                  <input
                    type="radio"
                    name="lesson-status"
                  ...
                  <div>
                    <div className="admin-status-name">
                      {t("admin.lessonStatusArchive")}
                    </div>
                    <div className="admin-status-desc">
                      {t("admin.statusArchivedDesc")}
                    </div>
                  </div>
                </label>
              </div>
