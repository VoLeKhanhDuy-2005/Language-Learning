...
const MatchDetailModal = ({ isOpen, onClose, matchId }) => {
  ...
  const selfOutcome =
    match && selfRecord ? getOutcomeStatus(selfRecord, match.winnerId) : "draw";
  const oppOutcome =
    match && oppRecord ? getOutcomeStatus(oppRecord, match.winnerId) : "draw";
    ...
    <div className="battle-modal-overlay" onClick={onClose}>
      ...
      >
        <div className="battle-detail-modal-header">
          ...
          <button
            className="battle-detail-close-btn"
            onClick={onClose}
            aria-label="Close"
          >
            <svg
              ...
              <div className="battle-detail-general-info">
                <div className="battle-detail-info-item">
                  ...
                  <span className="info-val">
                    {formatDate(match.finishedAt || match.updatedAt)}
                  </span>
                </div>
                <div className="battle-detail-info-item">
                ...
                <div className="battle-detail-info-item">
                  ...
                  <span className="info-val">
                    {formatTypeText(match.matchType)}
                  </span>
                </div>
              </div>
              ...
              <div className="battle-detail-vs-section">
                ...
                {selfRecord && (
                  <div className="battle-detail-player-card">
                    <div
                      className={`player-avatar ${!selfRecord.userId?.avatarUrl ? "avatar-placeholder" : ""}`}
                    >
                      {selfRecord.userId?.avatarUrl ? (
                        <img
                          src={selfRecord.userId.avatarUrl}
                          alt={selfRecord.userId.name}
                        />
                      ) : (
                    ...
                    <span className="player-name">
                      {selfRecord.userId?.name || t("battle.anonymous")}
                    </span>
                    <span
                      className={`player-badge-outcome battle-badge-${selfOutcome}`}
                    >
                      {selfOutcome === "win"
                        ? t("battle.win")
                        : selfOutcome === "lose"
                ...
                {oppRecord ? (
                  <div className="battle-detail-player-card">
                    <div
                      className={`player-avatar ${!oppRecord.userId?.avatarUrl ? "avatar-placeholder" : ""}`}
                    >
                      {oppRecord.userId?.avatarUrl ? (
                        <img
                          src={oppRecord.userId.avatarUrl}
                          alt={oppRecord.userId.name}
                        />
                      ) : (
                    ...
                    <span className="player-name">
                      {oppRecord.userId?.name || t("battle.anonymous")}
                    </span>
                    <span
                      className={`player-badge-outcome battle-badge-${oppOutcome}`}
                    >
                      {oppOutcome === "win"
                        ? t("battle.win")
                        : oppOutcome === "lose"
                  ...
                  <div className="battle-detail-player-card empty">
                    ...
                    <span className="player-badge-outcome battle-badge-draw">
                      {t("battle.draw")}
                    </span>
                    <div className="player-stats-summary">
                      <div className="summary-row">
                ...
                <div className="battle-detail-questions-section">
                  ...
                  <div className="questions-table">
                    <div className="questions-table-header">
                      ...
                      <span className="col-ans">
                        {t("battle.correctAnswer")}
                      </span>
                    </div>
