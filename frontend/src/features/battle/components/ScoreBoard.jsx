  ...
  return (
    <div className="battle-scoreboard-card">
      ...
      <div className="battle-score-player">
        <div
          className={`battle-score-avatar ${!user?.avatarUrl ? "avatar-placeholder" : ""}`}
        >
          {user?.avatarUrl ? (
            <img
              src={user.avatarUrl}
      ...
      {/* Player 2 (Opponent) */}
      <div
        className={`battle-score-player right ${isOpponentDisconnected ? "disconnected" : ""}`}
      >
        <div
          className={`battle-score-avatar ${!opponent?.avatarUrl ? "avatar-placeholder" : ""}`}
        >
          {opponent?.avatarUrl ? (
            <img
