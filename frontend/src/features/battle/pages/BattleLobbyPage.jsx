      ...
      <div className="battle-lobby-main">
        ...
        {error && (
          <div className="battle-error-banner">
            ...
            <button
              className="battle-error-close-btn"
        ...
        <div className="battle-modes-card">
          ...
          <div className="battle-mode-selection">
            ...
            >
              <span className="battle-mode-btn-title">
                {t("battle.modeMcq")}
              </span>
              <span className="battle-mode-btn-desc">
                {t("battle.modeMcqDesc")}
              </span>
            </button>
            <button
            ...
            <div style={{ display: "flex", flexDirection: "column" }}>
              <div className="battle-history-list">
                {history.map((match) => {
                  ...
                  const myId = user?.id || user?._id;
                  const myRecord = match.players.find(
                    (p) => p.userId && p.userId._id === myId,
                  ) || { score: 0 };
                  const oppRecord = match.players.find(
                    (p) => p.userId && p.userId._id !== myId,
                  ) || { score: 0 };
                  return (
                    <div
                    ...
                    >
                      ...
                      <div className="battle-history-right">
                        <span
                          className={`battle-history-badge battle-badge-${outcome}`}
                        >
                          {outcome === "win"
                            ? t("battle.win")
                            : outcome === "lose"
