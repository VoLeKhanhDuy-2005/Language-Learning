            ...
            return (
              ...
              >
                ...
                {isSubmitted && option.isCorrect && (
                  <svg
                    className="option-feedback-icon"
                    viewBox="0 0 24 24"
                    width="20"
                    height="20"
                    fill="currentColor"
            ...
            <div className="quiz-vocabulary-details">
                  ...
                  {card.phonetics?.map((phonetic, index) => {
                    ...
                    return phonetic.audio ? (
                      ...
                      >
                        ...
                        {label && (
                          <span className="details-audio-label">{label}</span>
                        )}
                      </button>
                    ) : null;
                  })}
                ...
                {card.phonetics?.map((phonetic, index) => {
                  ...
                  return phonetic.text ? (
                    <span key={index} className="details-phonetic-wrapper">
                      {label && (
                        <span className="details-phonetic-locale">{label}</span>
                      )}
              ...
              {(card.examples?.en || card.examples?.vi) && (
                <div className="details-examples-box">
                  <span className="example-box-title">
                    {t("flashcard.example")}
                  </span>
                  {card.examples?.en && (
