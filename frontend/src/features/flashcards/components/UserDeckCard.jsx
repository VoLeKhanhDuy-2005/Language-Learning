...
function UserDeckCard({ deck, onLearn, onEdit, onDelete }) {
  ...
  return (
    <div
      className="user-deck-card"
      onClick={() => onLearn && onLearn(deck._id)}
    >
      ...
      <div className="user-deck-card-footer">
        ...
        <div className="user-deck-card-word-count">
          <svg
            className="user-deck-card-word-icon"
            viewBox="0 0 24 24"
            width="14"
            height="14"
            fill="currentColor"
          ...
          <span>
            {deck.cardCount || 0} {t("deckDetail.wordsCount")}
          </span>
        </div>

        <div className="user-deck-card-actions">
          <button
            className="user-deck-btn-action btn-edit"
            onClick={handleEditClick}
            title={t("decks.editDeckTooltip")}
          >
            <svg
              viewBox="0 0 24 24"
              width="18"
          ...
          <button
            className="user-deck-btn-action btn-delete"
