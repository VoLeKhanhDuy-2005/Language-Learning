...
function DeckListPage({ onNavigate }) {
  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      let response;
      if (modalMode === "create") {
        response = await createUserDeck({
          title: modalTitle,
          description: modalDesc,
        });
      } else {
        response = await updateUserDeck(editingDeck._id, {
          title: modalTitle,
          description: modalDesc,
        });
      }
          ...
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            <div className="modal-header">
              <h3 className="modal-title">
                {modalMode === "create"
                  ? t("decks.modalCreateTitle")
                  : t("decks.modalEditTitle")}
              </h3>
              <button
            ...
            <form onSubmit={handleFormSubmit}>
              <div className="modal-body">
                ...
                <div className="form-group">
                  <label htmlFor="deck-desc" className="form-label">
                    {t("decks.labelDesc")}
                  </label>
                  <textarea
                    id="deck-desc"
