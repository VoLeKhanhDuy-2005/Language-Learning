    ...
    <div className="leaderboard-container">
      ...
      {error && (
        <div className="leaderboard-error-banner">
          <span>{error}</span>
          <button
            className="leaderboard-error-close"
            onClick={() => setError("")}
        ...
        {!loading && myRank && (
          <div className="my-rank-card">
            ...
            <div className="my-rank-info">
              <span className="my-rank-title">
                {t("leaderboard.yourRankCard")}
              </span>
              <span className="my-rank-value">
                {myRank.rank > 0
                  ? t("leaderboard.yourRankLabel", { rank: myRank.rank })
                  : "—"}
              </span>
              <span className="my-rank-xp">
                {t("leaderboard.yourXp", {
                  xp: (myRank.totalXp || 0).toLocaleString(),
                })}
              </span>
            </div>
          </div>
        ...
        <>
                  ...
                  <div className="podium-card">
                    <div className="podium-info-wrapper">
                      <span className="podium-name">
                        {firstPlace.name || t("leaderboard.anonymousUser")}
                      </span>
                      <span className="podium-level">
                        {t("leaderboard.currentLevel", {
              ...
              {secondPlace && (
                <div className="podium-item rank-2">
                  ...
                  <div className="podium-card">
                    <div className="podium-info-wrapper">
                      <span className="podium-name">
                        {secondPlace.name || t("leaderboard.anonymousUser")}
                      </span>
                      <span className="podium-level">
                        {t("leaderboard.currentLevel", {
              ...
              {thirdPlace && (
                <div className="podium-item rank-3">
                  ...
                  <div className="podium-card">
                    <div className="podium-info-wrapper">
                      <span className="podium-name">
                        {thirdPlace.name || t("leaderboard.anonymousUser")}
                      </span>
                      <span className="podium-level">
                        {t("leaderboard.currentLevel", {
          ...
          <div className="leaderboard-table-section">
            <div className="leaderboard-table-header">
              <h3 className="leaderboard-table-subtitle">
                {t("leaderboard.rankingSubtitle")}
              </h3>
            </div>
            <div className="leaderboard-list">
              {listData.map((item, index) => {
                const actualRank = showPodium
                  ? index + 4
                ...
                return (
                  <div
                    key={item.userId}
                    className={`leaderboard-row ${isCurrentUser ? "highlighted" : ""}`}
                  >
                    ...
                    <div className="leaderboard-cell-user">
                      ...
                      <span className="leaderboard-row-name">
                        {item.name || t("leaderboard.anonymousUser")}
                      </span>
                    </div>
