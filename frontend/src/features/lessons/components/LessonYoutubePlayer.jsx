...
const LessonYoutubePlayer = forwardRef(
  ({ lesson, videoId, startMs, endMs, onPlayerReadyStateChange }, ref) => {
        ...
        <div className="media-player-card">
          <div className="media-preview-container">
            {videoId ? (
              ...
              <div className="media-preview-placeholder">
                <img
                  src={lesson?.thumbnailUrl || "/hero.jpg"}
                  alt={lesson?.title}
          ...
          <div className="media-info-box">
            ...
            <p className="media-lesson-desc">
              {lesson?.description ||
                "Practice your speaking alignment and tone matching with YouTube segments."}
            </p>
          </div>
        </div>
      </aside>
