...
function HistoryModal({ onClose, lessonsMap, user, onNavigate }) {
  ...
  const [debouncedBattleSearchQuery, setDebouncedBattleSearchQuery] =
    useState("");
    ...
    try {
      ...
      if (res.success) {
        ...
        const lessonsWithData = data.map((l) => ({
          ...
          lastStudiedAt:
            l.userProgress?.updatedAt || l.userProgress?.createdAt || null,
        }));
          ...
          filteredItems = items.filter((match) => {
            ...
            const typeText =
              match.matchType === "queue"
                ...
                : t("battle.typeInvite");
            return (
              modeText.toLowerCase().includes(searchLower) ||
      ...
      <div className="hm-container" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="hm-search-filter">
          <input
            ...
            placeholder={
              activeTab === "lessons"
                ? t("profile.searchLessonPlaceholder")
                : t("profile.searchBattlePlaceholder")
            }
            value={
              activeTab === "lessons" ? lessonSearchQuery : battleSearchQuery
            }
            onChange={(e) => {
                    ...
                    {lessons.map((lesson) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td>
                            <span
                              className={`hm-status-pill ${status === "completed" ? "completed" : status === "in_progress" ? "in_progress" : "not_started"}`}
                            >
                              {status === "completed"
                                ? t("profile.completed")
                                : status === "in_progress"
                    ...
                    {battles.map((match, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <td>
                            <span
                              className={`hm-status-pill ${isDraw ? "draw" : isWinner ? "completed" : "in_progress"}`}
                            >
                              {isDraw
                                ? t("profile.draw")
                                : isWinner
          ...
          <div className="modal-container" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <button
                ...
                onClick={() =>
                  selectedLesson.modes?.includes("dictation") &&
                  handleSelectMode("dictation")
                }
              ...
              <button
                ...
                onClick={() =>
                  selectedLesson.modes?.includes("shadowing") &&
                  handleSelectMode("shadowing")
                }
